        ...
        !(function (t) {
              ...
              if (void 0 !== i[t]) i[t].push(n);
                ...
                (o.type = "text/javascript"),
                  ...
                  (o.src =
                    ...
                    "." +
                    {
                      1: "2feb01ade71883759dfeb6473b407b30",
                      2: "7db838345f9545c91ea4497f64abb814",
                      3: "7613ff7ff7df318da9a20cc5757e68c5",
                      4: "2cd9dbf10a7672164f38888260217c3c",
                      5: "97b9f758aae0736b4050c57ff0fb8702",
                      6: "e7653a8bc8be5342f5ecf22ae2e65c92",
                      7: "af76d8839be6d70ca562e44fda5922ff",
                    }[t] +
                    ".js"),
                  r.appendChild(o);
              }
          ...
          function (t, e, n) {
            ...
            n(261),
              ...
              p(),
              (r = new i()),
              s.exposeReadyPromise(r.promise, a.base, v),
              a.set("widgets", l),
            ...
            (function (t) {
              ...
              (function () {
                ...
                function D(t) {
                  ...
                  if (!$(t))
                    return (
                      S(i, new TypeError("You must pass an array to race.")), i
                    );
                ...
                function M(t) {
                  (this._id = lt++),
                    ...
                    (this._subscribers = []),
                    v !== t &&
                      (o(t) || F(), this instanceof M || U(), k(this, t));
                }
                function q() {
                  var t;
                ...
                (L.prototype._enumerate = function () {
                  ...
                  (L.prototype._settledAt = function (t, e, n) {
                    var r = this,
                      i = r.promise;
                    i._state === nt &&
                      (r._remaining--, t === it ? S(i, n) : (r._result[e] = n)),
          ...
          function (t, e, n) {
            ...
            function u(t) {
              return (
                (t = t || b), /^Mozilla\/5\.0 \(Linux; (U; )?Android/.test(t)
              );
            }
            function c(t, e) {
              return (
                (t = t || w), (e = e || b), t.postMessage && !(i(e) && t.opener)
              );
            }
            function d(t, e, n) {
              return (
            ...
            function m() {
              try {
                return (
                  w.localStorage.setItem("local_storage_support_test", "true"),
                  "undefined" != typeof w.localStorage
                );
              } catch (t) {
                return !1;
              }
            ...
            function o(t, e, n) {
              for (
                var r = n || t.target || t.srcElement,
                  s = m.list(r).map(function (t) {
                    return "." + t;
                  }),
                  a = s.concat(r.tagName),
                  u = 0,
                  c = a.length;
                u < c;
                u++
          ...
          function (t, e, n) {
            function r(t) {
              return (
                "string" == typeof t && T.test(t) && RegExp.$1.length <= 20
              );
            }
            function i(t) {
            ...
            function _(t) {
              return (
                !!L.test(t) && { ownerScreenName: RegExp.$1, slug: RegExp.$2 }
              );
            }
            function E(t) {
              return (
                !!O.test(t) && { ownerScreenName: RegExp.$1, slug: RegExp.$2 }
              );
            }
            function x(t) {
            ...
            var A = n(26),
              ...
              I = /^http(s?):\/\/pbs\.twimg\.com\//,
              R = /^#?([^.,<>!\s\/#\-()'"]+)$/,
              P = /twitter\.com(?::\d{2,4})?\/intent\/(\w+)/,
              j = /^https?:\/\/(?:www\.)?twitter\.com\/\w+\/timelines\/(\d+)/i,
              N = /^https?:\/\/(?:www\.)?twitter\.com\/i\/moments\/(\d+)/i,
              k =
          ...
          function (t, e, n) {
            ...
            function i() {
              ...
              return (
                !m.isFalseValue(t) &&
                (m.isTruthValue(t) ? a.body : a.querySelectorAll(t))
              );
            }
            function o(t) {
              var e;
                ...
                (e = c
                  ...
                  .then(function (t) {
                    p.trigger("loaded", { widgets: t }),
                      y.emitter.trigger(y.ALL_WIDGETS_RENDERED, { widgets: t });
                  })),
                c.always(e, function () {
                  h.resume();
                }),
            ...
            function s() {
              ...
              return (
                g.load(),
                t === !1 ? u.resolve() : (l.set("widgets.loaded", !0), o(t))
              );
            }
            var a = n(9),
              u = n(2),
          ...
          function (t, e, n) {
            ...
            function i(t) {
              ...
              return (
                ...
                e
                  ? e !== t.length
                    ? c.reject("non-Promise passed to .some")
                    : new c(function (e, n) {
                        function r() {
                          (i += 1), i === t.length && n();
                        }
            ...
            function o(t) {
              var e;
              return void 0 === t
                ? c.reject(new Error("undefined is not an object"))
                : Array.isArray(t)
                ? ((e = t.length),
                  e
                    ? new c(function (n, r) {
            ...
            function i(t) {
              ...
              f.forIn(n, function (t, e) {
                c.allSettled(
                  ...
                  e.forEach(function (t) {
                    u.all([t.hydrate(), t.insertIntoDom()])
                      .then(d(t.render, t))
          ...
          function (t, e, n) {
            ...
            (i.fromRawTask = function (t) {
              ...
              (i.prototype.fail = function () {
                ...
                return this._srcEl
                  ? d.always(
                      ...
                      function () {
                        a.trigger("rendered", { target: t._srcEl }),
                          t._resolve(t._srcEl);
                      }
                    )
              ...
              (i.prototype.success = function () {
                a.trigger("rendered", { target: this._sandbox.sandboxEl }),
            ...
            (r.prototype.add = function (t) {
              ...
              return (
                ...
                this._hasFlushBeenScheduled ||
                  ((this._hasFlushBeenScheduled = !0), o(s(this._flush, this))),
                e.promise
              );
            }),
          ...
          function (t, e, n) {
            function r(t) {
              ...
              for (
                ...
                if (((n = e[i]), /^twitter:/.test(n.getAttribute("name"))))
                  r = n.getAttribute("name").replace(/^twitter:/, "");
                else {
          ...
          function (t, e, n) {
              ...
              return R
                ...
                : ((h = new E(m)),
                  h
                    ...
                    .then(function () {
                      h.setTitle("Twitter analytics iframe"),
                        (f = c()),
                        (l = d()),
                        P.resolve([f, l]);
                    }),
            ...
            function i(t, e) {
              ...
              _.isObject(t) &&
                _.isObject(e) &&
                ((i = b.flattenClientEventPayload(t, e)),
                (n = f.firstChild),
                (n.value = +(+n.value || i.dnt || 0)),
                (r = h.createElement("input")),
                (r.type = "hidden"),
                (r.name = "l"),
                (r.value = b.stringify(i)),
                f.appendChild(r));
            }
            function o(t, e) {
              var n = !_.isObject(t),
            ...
            function s(t, e, n, r) {
              o(t, e) ||
                ...
                P.promise.then(function () {
                  i(
                    b.formatClientEventNamespace(t),
                    b.formatClientEventData(e, n, r)
                  );
                }));
            }
            function a() {
              return P.promise.then(function () {
                var t;
                return f.children.length <= 2
                  ? y.reject()
                  : ((t = y
                      .all([
                        h.doc.body.appendChild(f),
                        h.doc.body.appendChild(l),
                      ])
                      .then(function (t) {
                        var e = t[0],
                          n = t[1];
            ...
            function c() {
              ...
              return (
                I++,
                (t.action = b.CLIENT_EVENT_ENDPOINT),
                (t.method = "POST"),
                (t.target = C + I),
                (t.id = S + I),
                (e.type = "hidden"),
          ...
          function (t, e, n) {
            ...
            function i(t, e) {
              return (
                ...
                !(
                  !a.isFramed() || !u.isUrlSensitive(a.rootDocumentLocation())
                ) ||
          ...
          function (t, e, n) {
            ...
            function i(t) {
              return v.aug({ client: "tfw" }, t || {});
            }
            function o(t, e, n) {
              var r = (t && t.widget_origin) || h.referrer;
              return (
                (t = s("tfw_client_event", t, r)),
                (t.client_version = _),
            ...
            function a(t, e) {
              var n = {};
              return (
                (e = e || {}), (e.association_namespace = i(t)), (n[T] = e), n
              );
            }
            function u(t, e) {
              return v.aug({}, e, { event_namespace: t });
            }
            function c(t) {
            ...
            function l(t) {
              ...
              return t.item_ids && t.item_ids.length > 1
                ? ((e = Math.floor(t.item_ids.length / 2)),
                  ...
                  (s = [
                    v.aug({}, t, { item_ids: n, item_details: r }),
                    v.aug({}, t, { item_ids: i, item_details: o }),
                  ]))
                : [t];
            }
            var h = n(9),
          ...
          function (t, e) {
            t.exports = { version: "d699013:1526883857787" };
          },
          function (t, e, n) {
            var r = n(55),
              i = n(64);
          ...
          function (t, e, n) {
            ...
            s.aug(i.prototype, {
              ...
              build: function (t) {
                ...
                this.Component;
                return (
                  s.aug(this.Component.prototype.boundParams, t),
              ...
              params: function (t) {
                ...
                (t = t || {}),
                  (this.Component.prototype.paramConfigs = s.aug({}, t, e));
              },
              define: function (t, e) {
          ...
          function (t, e, n) {
            ...
            function o(t, e, n) {
              ...
              return (
                t.some(function (t) {
                  if (((t = a.isType("function", t) ? t() : t), e(t)))
                    return (r = n(t)), !0;
                }),
                r
              );
          ...
          function (t, e, n) {
            function r(t, e, n, r) {
              return (
                (e = y.aug({ id: t }, x, e)), (n = y.aug({}, A, n)), m(e, n, r)
              );
            }
            function i(t) {
              try {
            ...
            function o(t, e, n, i, o) {
              ...
              return (
                ...
                (d.src = [
                  ...
                  'catch (e) { document.domain="' + a.domain + '"; }',
                  "window.parent." + b.fullPath(["sandbox", u]) + "();",
                ].join("")),
                d.addEventListener("error", s.reject, !1),
                c.write(function () {
                ...
                t.override("insert", function (t, e, n, s) {
                  ...
                  return (
                    ...
                    u.promise.then(function (t) {
                      ...
                      return (
                        (a._iframe = t),
                        a.win.addEventListener("resize", e, !1),
                        w.all([
                          a._setTargetToBlank(),
                          a.addRootClass(C),
                          a.prependCss(S),
              ...
              return (
                ...
                void 0 !== o
                  ...
                  : ((e.style.display = "none"),
                    s.add(e, t),
                    (n.type = "text/css"),
                    n.appendChild(a.createTextNode(i)),
          ...
          function (t, e, n) {
            ...
            var h = n(47),
              ...
              y = 2083,
              b = [],
              _ = p.url(m.CLIENT_EVENT_ENDPOINT, { dnt: 0, l: "" }),
          ...
          function (t, e, n) {
            function r(t, e) {
              (this._inputsQueue = []),
                (this._task = t),
                (this._isPaused = !1),
                (this._flushDelay = (e && e.flushDelay) || s),
                (this._pauseLength = (e && e.pauseLength) || a),
          ...
          function (t, e, n) {
            function r() {
              ...
              return f.ie9() ||
                ...
                ? void _().resolve(i())
                : ((t = { origin: h.origin, settingsEndpoint: d.settings() }),
                  (e = g.url(s.resourceBaseUrl + s.widgetIframeHtmlPath, t)),
                  (n = function (t) {
                    var n;
                    if (e.substr(0, t.origin.length) === t.origin)
                      try {
                        (n =
                          "string" == typeof t.data ? l.parse(t.data) : t.data),
                          n.namespace === p.settings &&
                            _().resolve(i(n.settings));
                      } catch (t) {}
                  }),
            ...
            function i(t) {
              ...
              return new w(
                n.is_bucketed,
                n.should_obtain_cookie_consent,
                n.experiments
              );
            }
            function o() {
          ...
          function (t, e) {
            t.exports = {
              tweetButtonHtmlPath:
                "/widgets/tweet_button.049716a23792bca881820db70e17250b.{{lang}}.html",
              followButtonHtmlPath:
                "/widgets/follow_button.049716a23792bca881820db70e17250b.{{lang}}.html",
              hubHtmlPath: "/widgets/hub.html",
              widgetIframeHtmlPath:
                "/widgets/widget_iframe.049716a23792bca881820db70e17250b.html",
          ...
          function (t, e) {
            function n(t, e, n) {
              (this.isBucketed = t),
                (this.shouldObtainCookieConsent = e),
                (this.experiments = n || {});
            }
            t.exports = n;
          },
              ...
              return (
                ...
                a.aug(t.prototype, {
                    ...
                    return (
                      ...
                      t
                        ? ((e = this.selectors[e] || e),
                          a.toRealArray(t.querySelectorAll(e)))
                        : []
                    );
                  },
                  selectOne: function () {
                  ...
                  on: function (t, e, n) {
                    ...
                    this.el &&
                      ((t = (t || "").split(/\s+/)),
                      2 === arguments.length ? (n = e) : (s = e),
                      (s = this.selectors[s] || s),
                      (n = u(n, this)),
                      t.forEach(s ? i : r));
                  },
                }),
          ...
          function (t, e, n) {
            ...
            function i(t, e, n) {
              ...
              return (
                (n = r(n)),
                (i = a.isRtlLang(e) ? "rtl" : "ltr"),
                (o = [t, u.css, n, i, "css"].join(".")),
                d.resourceBaseUrl + "/css/" + o
              );
            }
            function o() {
              return (
                d.resourceBaseUrl +
                "/css/" +
                ["periscope_on_air", u.css, "css"].join(".")
              );
            }
            function s() {
              return (
          ...
          function (t, e) {
            t.exports = { css: "2a370b305fba4454465a8c70868409af" };
          },
          ,
          function (t, e, n) {
            function r(t) {
              t.define("injectRefUrlParams", function (t) {
                t.getAttribute(s) ||
                  (t.setAttribute(s, !0), (t.href = i(t.href)));
              }),
          ...
          function (t, e, n) {
            function r(t) {
              t.params({ partner: { fallback: c(d.val, d, "partner") } }),
                ...
                t.define("scribeData", function () {
                  return {
                    ...
                    widget_site_user_id: f.asNumber(d.val("site:id")),
                    widget_creator_screen_name: l(d.val("creator")),
                    widget_creator_user_id: f.asNumber(d.val("creator:id")),
                  };
                }),
                t.define("scribe", function (t, e, n) {
                  (t = u.aug(this.scribeNamespace(), t || {})),
                    (e = u.aug(this.scribeData(), e || {})),
                    o.scribe(t, e, !1, n);
                }),
                t.define("scribeInteraction", function (t, e, n) {
                  var r = s.extractTermsFromDOM(t.target);
                  (r.action = t.type),
                    "url" === r.element &&
                      (r.element = s.clickEventElement(t.target)),
                    this.scribe(r, e, n);
                });
            }
            var i = n(11),
            ...
            function r(t, e) {
              ...
              if (t)
                return (
                  (r = e ? [t, e] : [t]),
                  (n = a(r)),
                  { item_ids: Object.keys(n), item_details: n }
                );
            }
            function i(t) {
              t.selectors({
                ...
                ? ((t = Array.isArray(t) ? t : [t]),
                  t.reduce(function (t, e) {
                    var n = e.getAttribute("data-tweet-id"),
                      ...
                      o =
                        e.getAttribute("data-tweet-item-type") ===
                        i.QUOTE_TWEET.toString();
                    return (
                      o
                        ? (t[n] = { item_type: i.QUOTE_TWEET })
                        : n === r
              ...
              t.defineStatic("isSupported", function () {
                ...
                t.override("insert", function (t, e, n, r) {
                  ...
                  return (
                    ...
                    (o.id = t),
                    s.appendChild(c),
                    a.delegate(c, "click", "A", function (t, e) {
          ...
          function (t, e, n) {
            function r(t) {
              new o()
                .attachReceiver(new s.Receiver(i, "twttr.button"))
          ...
          function (t, e, n) {
            ...
            function s(t, e) {
              ...
              (n = y.decodeURL(t.src).name),
                ...
                r >= o ||
                  ...
                  (t.src = y.url(i, { format: "jpg", name: I[s] })));
            }
            function a(t) {
                ...
                g
                  ...
                  .forEach(function (t) {
                    var i = h(
                      ...
                      E.effectiveWidth(t.parentElement) || e,
                      n
                    );
                    r(function () {
                      t.setAttribute("width", i.width),
                        t.setAttribute("height", i.height),
                        x.present(t, "wvp-player-container")
            ...
            function m(t) {
              w.inlineStyle() ||
                (p(t, ".MediaCard-widthConstraint", "maxWidth", A),
                p(t, ".MediaCard-mediaContainer", "paddingBottom", S),
                p(t, ".CroppedImage-image", "top", T),
                p(t, ".CroppedImage-image", "left", C));
            }
            var v = n(7),
              g = n(12),
              w = n(67),
          ...
          function (t, e, n) {
            function r(t) {
              t.define("injectPublisherMetadataParams", function (t) {
                t.getAttribute(s) ||
                  (t.setAttribute(s, !0), (t.href = i(t.href)));
              }),
                t.after("render", function () {
                  this.on("click", "A", function (t, e) {
                    o.isStatus(e.href) && this.injectPublisherMetadataParams(e);
                  });
                });
            }
            var i = n(145),
              o = n(25),
              s = "data-url-pubmeta-attrs-injected";
            t.exports = r;
          },
          function (t, e, n) {
            function r(t) {
              var e = {};
              return (
                o.val("site") && (e.tfw_site = i(o.val("site"))),
                o.val("creator") && (e.tfw_creator = i(o.val("creator"))),
                s.url(t, e)
              );
            }
            var i = n(105),
          ...
          function (t, e, n) {
            function r(t, e, n) {
              var r,
                ...
                o = a(t, n);
              if (o)
                return (r = d.createPlayerForTweet(o.element, e, o.options))
                  ? (i.resolve(r), i.promise)
                  : i.reject(new Error("unable to create tweet video player"));
            }
            function i(t, e, n) {
              var r,
                i = new u(),
                o = a(t, n);
              return o
                ? ((r = d.createPlayerForLiveVideo(o.element, e, o.options)),
                  r.on("ready", function () {
            ...
            function a(t, e) {
              ...
              if (
                ...
                (n = c(t, ".wvp-player-container")),
                n.length > 0)
              )
                return f && d.setBaseUrl(f), { element: n[0], options: r };
            }
            var u = n(1),
              c = n(86),
              d = n(152),
          ...
          function (t, e, n) {
              ...
              t.selectors({ clickToOpen: ".js-clickToOpenTarget" }),
                ...
                t.define("scribeOpenClick", function (t) {
                  var e = a.extractTermsFromDOM(t.target),
                    n = { associations: a.formatTweetAssociation(e) };
            ...
            t.exports = s.couple(n(104), r);
          },
          function (t, e, n) {
            function r(t) {
              a.isTwitterURL(t) && (t = s(t)),
                a.isStatus(t) && (t = o(t)),
                i.open(t);
            }
            var i = n(7),
                ...
                t.after("render", function () {
                  this.on("click", "A", function (t, e) {
                    c.isIntentURL(e.href) &&
                      ...
                      s.open(e.href, this.sandbox.sandboxEl, t));
                  });
                });
            }
            var i = n(22),
          ...
          function (t, e, n) {
            function r(t) {
              ...
              t.after("show", function () {
                var t, r, i;
                n.nextBoolean() &&
                  ((t = this.sandbox.width),
                  (r = this.sandbox.height),
                  (i = { widget_width: t, widget_height: r }),
                  this.scribe(e, i));
              });
            }
            var i = n(91),
          ...
          function (t, e, n) {
            function r(t) {
              t.selectors({ inViewportMarker: ".js-inViewportScribingTarget" }),
          ...
          function (t, e, n) {
            ...
            (d.prototype._register = function (t, e, n) {
              ...
              return a.hasIntersectionObserverSupport()
                ...
                : ((i = {
                  ...
                  1 === this.observers.length &&
                    (this.unlisten = o.addScrollListener(
              ...
              (d.prototype._unregister = function (t) {
                var e;
                a.hasIntersectionObserverSupport() &&
                t instanceof s.IntersectionObserver
                  ? t.disconnect()
                  : ((e = this.observers.indexOf(t)),
                    e > -1 &&
          ...
          function (t, e, n) {
            function r(t, e) {
              ...
              return (
                (e = e || {}),
                (r = e.viewportWidth || o.innerWidth),
                (n = e.viewportHeight || o.innerHeight),
                (s = t.getBoundingClientRect()),
                t.ownerDocument !== i &&
                  e.sandboxEl &&
                  ((a = e.sandboxEl.getBoundingClientRect()),
                  (s = {
                    top: s.top + a.top,
              ...
              t.params({
                ...
                t.define("poll", function (t, e) {
                  ...
                  return (
                    ...
                    a.fetch(this.pollEndpoint, o, u, this.cbId(e)).then(r, i)
                  );
                });
            }
            var s = n(137),
          ...
          function (t, e, n) {
            ...
            function i(t) {
              t.params({
                ...
                t.before("initialize", function () {
                  var t = r(this.params);
                  if (s.isEmptyObject(t) && !this.params.id)
            ...
            function r(t) {
              t.params({
                ...
                t.overrideProperty("pollEndpoint", {
                  get: function () {
                    return s.timelinePreconfigured([
                      "paged",
          ...
          function (t, e, n) {
            ...
            var o = n(21),
              ...
              c = n(85)(),
              d = n(226),
              f = "blockquote.twitter-tweet, blockquote.twitter-video",
          ...
          function (t, e, n) {
            ...
            function i() {
              o &&
                o.length === a &&
                (s.emitter.trigger(s.ALL_WIDGETS_AND_IMAGES_LOADED, o),
                (o = null));
            }
            var o,
              s = n(242),
          ...
          function (t, e, n) {
            function r(t) {
              var e,
                n = a.toRealArray(arguments).slice(1);
              return a.isObject(t) || u.isString(t)
                ? ((t = t || {}),
                  n.forEach(function (t) {
                  ...
                  e || ((e = {}), n.push(e)),
                  u.isString(t) &&
                    (t = a.aug({}, e, { sourceType: "widget", widgetId: t })),
                  (t.lang = e.lang),
                  ...
                  h.apply(this, n))
                : p.reject("data source must be a string or an object.");
            }
            function i(t) {
            ...
            var o = n(11),
              ...
              p = n(2),
              m = { createTimeline: r };
            s.isTwitterURL(o.href) &&
              (m.createTimelinePreview = function (t, e, n) {
                var r = {
                  previewParams: t,
                  useLegacyDefaults: !0,
                  isPreviewTimeline: !0,
            ...
            /^loade|c/.test(a.readyState) && (c = 1),
              ...
              l.doScroll &&
                a.attachEvent(
                  ...
                  (i = function () {
                    /^c/.test(a.readyState) &&
                      (a.detachEvent("onreadystatechange", i), r());
                  })
                ),
              (s = l.doScroll
                ? function (t) {
